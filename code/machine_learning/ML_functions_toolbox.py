...
from ml_graph_toolbox import push_heatmap
...
# Number of trees in random forest
    ...
    rf_random = RandomizedSearchCV(estimator = rf, param_distributions = random_grid, n_iter = 100, cv = kfold, verbose=2, random_state=42, n_jobs = -1,scoring="accuracy")
...
# Number of trees in random forest
    ...
    # Random search of parameters, using 3 fold cross validation, 
    # search across 100 different combinations, and use all available cores
    xgb_random = RandomizedSearchCV(estimator = modelxgb, param_distributions = random_grid, n_iter = 100, cv = kfold, verbose=2, random_state=42, n_jobs = -1,scoring='accuracy')
    # Fit the random search model
...
============================================================================================================
"""
def optimize_svc_hyperparameters(X_train,y_train):
    ...
    # Random search of parameters, using 3 fold cross validation, 
    # search across 100 different combinations, and use all available cores
    svc_random = RandomizedSearchCV(estimator = modelsvc, param_distributions = random_grid, n_iter = 100, cv = kfold, verbose=10, random_state=42, n_jobs = -1,scoring='accuracy')
    # Fit the random search model
